...
function alienship_alert($atts, $content = null) {
   ...
   if ($type != "alert") {
   return '<div class="alert alert-'.$type.' fade in"><a class="close" data-dismiss="alert">x</a><strong>'. do_shortcode($heading) .'</strong> ' . do_shortcode($content) . '</div>';
   } else {
   return '<div class="'.$type.' fade in"><a class="close" data-dismiss="alert">x</a><strong>'. do_shortcode($heading) .'</strong>' . do_shortcode($content) . '</div>';
   }
}
