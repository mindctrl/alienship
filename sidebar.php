...
<?php if ( current_theme_supports( 'theme-layouts' ) && !is_admin() && 'layout-1c' !== theme_layouts_get_layout() || !current_theme_supports( 'theme-layouts' ) ) {
	...
	<div id="secondary" class="<?php echo apply_filters( 'alienship_secondary_container_class', 'col-sm-3' ); ?>">

		<?php do_action( 'alienship_sidebar_before' ); ?>
		<div id="sidebar" class="<?php echo apply_filters( 'alienship_sidebar_container_class', 'widget-area well' ); ?>" role="complementary">
			<?php
